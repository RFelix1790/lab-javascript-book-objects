...
const booksArray = [
  ...
  author: "Ernest Hemingway",
   details: {
   language: "English",
   description:"One of Hemingway's most famous works, it tells the story of Santiago...ils:",
}
  },
  {
    title: "The Airbnb Story",
...
for(let key in booksArray){
  const readingTime = Math.ceil((booksArray[key].pages * 500) / 90);
 booksArray[key].readingTime=readingTime;
